...
void main()
{
  ...
  Debug("Wrote this many scripts to locals "+IntToString(GetLocalInt(GetModule(), "hooked")));
...
int LoadScriptSet()
{
  int b = FALSE; //SetEventScript(GetModule(), EVENT_SCRIPT_MODULE_ON_ACQUIRE_ITEM, );
